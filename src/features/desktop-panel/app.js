...
function createRefs() {
  return {
    ...
    updateInstallConfirm: document.querySelector("#updateInstallConfirm"),
    updateInstallConfirmMessage: document.querySelector("#updateInstallConfirmMessage"),
    cancelUpdateInstallButton: document.querySelector("#cancelUpdateInstallButton"),
    confirmUpdateInstallButton: document.querySelector("#confirmUpdateInstallButton"),
